...
class CustomConnectionsXeroClient extends MCPXeroClient {
  ...
  public async getClientCredentialsToken(): Promise<TokenSet> {
    const scope =
      "accounting.transactions accounting.contacts accounting.settings accounting.reports.read accounting.journals.read payroll.settings payroll.employees payroll.timesheets";
